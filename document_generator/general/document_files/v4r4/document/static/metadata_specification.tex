...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{../../../static/figures/iso_metadata_obj.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../../../static/figures/ghrsst_metadata_translation.png}
