...
\par Dynamic sea surface height interpolated on the lat-lon regular 0.5-degree model grid from ECCO V4r4 on 2017-12-29.
...
\begin{itemize}
    \item GRID\_GEOMETRY\_ECCO\_V4r4\_lat-lon\_0p50deg.nc
\end{itemize}
