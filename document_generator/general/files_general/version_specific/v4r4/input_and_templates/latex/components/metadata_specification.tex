...
that contain metadata elements or other objects that, in turn, contain other elements or objects.
The root element is MI\_Metadata1 \footnotemark{}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{iso_metadata_obj.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{ghrsst_metadata_translation.png}
