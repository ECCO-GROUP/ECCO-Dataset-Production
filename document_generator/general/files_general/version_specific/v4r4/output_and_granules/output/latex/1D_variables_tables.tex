...
\subsection{1D dataset GLOBAL\_MEAN\_ATM\_SURFACE\_PRES}
\newp
...
\newp
\pagebreak
\subsection{dataset: GLOBAL\_MEAN\_ATM\_SURFACE\_PRES, variable: Pa\_global}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{Attributes description for 'Pa\_global'}
