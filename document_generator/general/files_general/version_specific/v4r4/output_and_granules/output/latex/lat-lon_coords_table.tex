...
\subsection{Overview  of GRID\_GEOMETRY\_ECCO (lat-lon)}
\newp
...
\newp
\pagebreak
\subsection{hFacC from GRID\_GEOMETRY\_ECCO (lat-lon)}
...
\caption{hFacC from GRID\_GEOMETRY\_ECCO (lat-lon)}
\label{tab:table-GRID_GEOMETRY_ECCO_hFacC-Plot}
\end{figure}
\newpage
\pagebreak
\subsection{maskC from GRID\_GEOMETRY\_ECCO (lat-lon)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
...
\caption{maskC from GRID\_GEOMETRY\_ECCO (lat-lon)}
