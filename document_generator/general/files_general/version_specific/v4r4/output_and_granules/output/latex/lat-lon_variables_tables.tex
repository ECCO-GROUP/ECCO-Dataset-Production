...
\subsection{Overview  of SEA\_SURFACE\_HEIGHT (lat-lon)}
\newp
...
\newp
\pagebreak
\subsection{SSH from SEA\_SURFACE\_HEIGHT (lat-lon)}
...
\caption{SSH from SEA\_SURFACE\_HEIGHT (lat-lon)}
\label{tab:table-SEA_SURFACE_HEIGHT_SSH-Plot}
\end{figure}
\newpage
\pagebreak
\subsection{SSHIBC from SEA\_SURFACE\_HEIGHT (lat-lon)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
...
\caption{SSHIBC from SEA\_SURFACE\_HEIGHT (lat-lon)}
\label{tab:table-SEA_SURFACE_HEIGHT_SSHIBC-Plot}
\end{figure}
\newpage
\pagebreak
\subsection{SSHNOIBC from SEA\_SURFACE\_HEIGHT (lat-lon)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
...
\caption{SSHNOIBC from SEA\_SURFACE\_HEIGHT (lat-lon)}
