...
\rowcolor{Apricot}\hspace{0.5cm}\hspace{0.5cm}& \hangindent=2em i:comment = "In the Arakawa C-grid system, tracer (e.g., THETA) and 'v' variables (e.g., VVEL) have the same x coordinate on the model grid."\\
