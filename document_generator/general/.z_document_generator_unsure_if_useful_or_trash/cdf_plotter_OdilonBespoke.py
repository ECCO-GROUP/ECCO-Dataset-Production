# BL: SO MUCH HARDCODED BS (ALL THE FRICKIN PATHS, OMG) IN HERE, JFC (SAME ISSUE IN "cdf_plotter.py", which I am guessing Odilon used as the base for this file, so this was likely a Jose issue...)
...
#-------------------------------------------------------------------------------------------------
#----------------------------------------- Plotting Functions ------------------------------------
def data_var_plot(version_string, ds:xr.Dataset, field:xr.DataArray, directory:str='none', colorbar:bool=True, coords:bool=False)->str:
    """
    ...
    if 'native' in ds.attrs['product_name']:
        if directory == 'none' and not coords:
            directory = 'images/plots/'+version_string+'/native_plots/'
        elif directory == 'none' and coords:
            directory = 'images/plots/'+version_string+'/native_plots_coords/'
        ...
        if directory == 'none' and not coords:
            directory = 'images/plots/'+version_string+'/latlon_plots/'
        elif directory == 'none' and coords:
            directory = 'images/plots/'+version_string+'/latlon_plots_coords/'
