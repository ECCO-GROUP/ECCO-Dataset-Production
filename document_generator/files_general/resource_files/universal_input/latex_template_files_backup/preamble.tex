...
\hypersetup{
    ...
    citecolor=green,
    filecolor=magenta,
    pdftitle={ECCO VERSION-V-NUM-r-NUM-placeholder Compendium},
}
\urlstyle{same}
...
\fancyhead[R]{\small ECCO VERSION-V-NUM-r-NUM-placeholder Dataset Catalog and Variable Compendium\\}
...
%\fancyfoot[C]{\small ECCO VERSION-V-NUM-r-NUM-placeholder Dataset Catalog and Variable Compendium \\
%Last saved: \today{} \currenttime, \\ \Large{-- \thepage{} --}}
% Last saved: \today{} \currenttime, \\ \Large{-- \thepage{} --}}
...
\title{The ECCO VERSION-V-NUM-r-NUM-placeholder Dataset Catalog and Variable Compendium}
