\pagebreak
\section{ECCO VERSION-V-NUM-r-NUM-placeholder Team}
The production of the ECCO VERSION-V-NUM-r-NUM-placeholder state estimate was made possible by the ongoing contributions of the following people:
...
\begin{tabular}{m{0.25\textwidth} m{0.03\textwidth} m{0.25\textwidth} m{0.03\textwidth} m{0.25\textwidth}}
    \includegraphics[width=0.3\textwidth]{ecco_logo_800_726.png} & & \includegraphics[width=0.3\textwidth]{logo_jpl.png} & & \includegraphics[width=0.3\textwidth]{logo_mit.png}\\ 

    \includegraphics[width=0.3\textwidth]{logo_aer.png} & & \includegraphics[width=0.3\textwidth]{logo_uta.png} & & \includegraphics[width=0.3\textwidth]{ecco_teams_sjsu.png}\\

    \includegraphics[width=0.2\textwidth]{logo-podaac.png} & &  & & \includegraphics[width=0.25\textwidth]{logo-nasa.jpg}\\ 
\end{tabular}
\end{center}
