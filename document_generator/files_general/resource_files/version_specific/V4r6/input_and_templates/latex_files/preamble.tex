...
\fancyhead[R]{\small ECCO V4r6 Dataset Catalog and Variable Compendium\\}
%ECCO version 4 release 6}
\fancyfoot[R]{\thepage}
}
%Last saved: \today{} \currenttime, \\ \Large{-- \thepage{} --}}

%% OK: the line below specify the note on bottom-center of each page of the document
%\fancyfoot[C]{\small ECCO V4r6 Dataset Catalog and Variable Compendium \\
%Last saved: \today{} \currenttime, \\ \Large{-- \thepage{} --}}
% Last saved: \today{} \currenttime, \\ \Large{-- \thepage{} --}}
...
\title{The ECCO V4r6 Dataset Catalog and Variable Compendium}
