...
\subsection{GLOBAL\_MEAN\_ATM\_SURFACE\_PRES}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/Global_Mean_Atmospheric_Pressure/Pa_global.png}
\caption{Pa\_global (1D)}
\label{tab:table-GLOBAL_MEAN_ATM_SURFACE_PRES_Pa_global-Plot}
\end{figure}
\newpage
\subsection{GLOBAL\_MEAN\_SEA\_LEVEL}
\subsubsection{Overview}
\newp
...
\caption{Coordinates and variables from GLOBAL\_MEAN\_SEA\_LEVEL (1D)}
...
\newp
\pagebreak
\subsubsection{global\_mean\_barystatic\_sea\_level\_anomaly (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.44\textwidth}|m{0.38\textwidth}|m{0.12\textwidth}|}
\caption{global\_mean\_barystatic\_sea\_level\_anomaly from GLOBAL\_MEAN\_SEA\_LEVEL (1D)}\label{tab:table-GLOBAL_MEAN_SEA_LEVEL_global_mean_barystatic_sea_level_anomaly} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/Global_Mean_Sea_Level/global_mean_barystatic_sea_level_anomaly.png}
\caption{global\_mean\_barystatic\_sea\_level\_anomaly (1D)}
\label{tab:table-GLOBAL_MEAN_SEA_LEVEL_global_mean_barystatic_sea_level_anomaly-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{global\_mean\_sea\_level\_anomaly (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.44\textwidth}|m{0.38\textwidth}|m{0.12\textwidth}|}
\caption{global\_mean\_sea\_level\_anomaly from GLOBAL\_MEAN\_SEA\_LEVEL (1D)}\label{tab:table-GLOBAL_MEAN_SEA_LEVEL_global_mean_sea_level_anomaly} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/Global_Mean_Sea_Level/global_mean_sea_level_anomaly.png}
\caption{global\_mean\_sea\_level\_anomaly (1D)}
\label{tab:table-GLOBAL_MEAN_SEA_LEVEL_global_mean_sea_level_anomaly-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{global\_mean\_sterodynamic\_sea\_level\_anomaly (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.44\textwidth}|m{0.38\textwidth}|m{0.12\textwidth}|}
\caption{global\_mean\_sterodynamic\_sea\_level\_anomaly from GLOBAL\_MEAN\_SEA\_LEVEL (1D)}\label{tab:table-GLOBAL_MEAN_SEA_LEVEL_global_mean_sterodynamic_sea_level_anomaly} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/Global_Mean_Sea_Level/global_mean_sterodynamic_sea_level_anomaly.png}
\caption{global\_mean\_sterodynamic\_sea\_level\_anomaly (1D)}
\label{tab:table-GLOBAL_MEAN_SEA_LEVEL_global_mean_sterodynamic_sea_level_anomaly-Plot}
\end{figure}
\newpage
\subsection{SBO\_CORE\_PRODUCTS}
\subsubsection{Overview}
\newp
This dataset provides a 1D field of the core products of the IERS Special Bureau for the Oceans from the ECCO Version 4 Release 4 (V4r4) ocean and sea-ice state estimate. The dataset is provided on instantaneous hourly snapshot aas well as daily-average and monthly-average time resolution.
\\\\
Note: Dataset fields include core products of the IERS Special Bureau for the Oceans (https://euler.jpl.nasa.gov/sbo/sbo\_home.html), including ocean angular momentum (OAM), center of mass (COM) and global ocean mass, calculated using the basic formulation of Gross et al. (2000). Further details on the available fields are provided in Quinn et al. (2019).
\\
\begin{longtable}{|m{0.15\textwidth}|m{0.64\textwidth}|m{0.12\textwidth}|}
\caption{Coordinates and variables from SBO\_CORE\_PRODUCTS (1D)}
\label{tab:table-<xarray.Dataset> Size: 49MB
Dimensions:    (time: 227904)
Coordinates:
  * time       (time) datetime64[ns] 2MB 1992-01-01T13:00:00 ... 2017-12-31T1...
Data variables: (12/26)
    xoamc      (time) float64 2MB ...
    yoamc      (time) float64 2MB ...
    zoamc      (time) float64 2MB ...
    xoamp      (time) float64 2MB ...
    yoamp      (time) float64 2MB ...
    zoamp      (time) float64 2MB ...
    ...         ...
    ycom_fw    (time) float64 2MB ...
    zcom_fw    (time) float64 2MB ...
    mass_gc    (time) float64 2MB ...
    xoamp_dsl  (time) float64 2MB ...
    yoamp_dsl  (time) float64 2MB ...
    zoamp_dsl  (time) float64 2MB ...
Attributes: (12/48)
    acknowledgement:              This research was carried out by the Jet Pr...
    author:                       Ian Fenty and Ou Wang
    cdm_data_type:                Grid
    ...
    uuid:                         9429992a-86d8-11eb-a688-f8f21e2ee3e0-fields} \\ 
\hline \endfirsthead \endhead \endfoot \hline \endlastfoot
\rowcolor{lightgray} \multicolumn{1}{|c|}{\textbf{Coordinates}} & \multicolumn{1}{|c|}{\textbf{Description of data coordinates}} & \multicolumn{1}{|c|}{\textbf{Unit}}\\ \hline
time &Snapshot time &--none--  \\ \hline
\rowcolor{lightgray} \multicolumn{1}{|c|}{\textbf{Variables}} & \multicolumn{1}{|c|}{\textbf{Description of data variables}} & \multicolumn{1}{|c|}{\textbf{Unit}}\\ \hline
...
\newp
\pagebreak
\subsubsection{mass (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{mass from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_mass} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/mass.png}
\caption{mass (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_mass-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{mass\_fw (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{mass\_fw from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_mass_fw} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/mass_fw.png}
\caption{mass\_fw (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_mass_fw-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{mass\_gc (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{mass\_gc from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_mass_gc} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/mass_gc.png}
\caption{mass\_gc (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_mass_gc-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{mass\_si (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{mass\_si from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_mass_si} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/mass_si.png}
\caption{mass\_si (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_mass_si-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{sboarea (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{sboarea from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_sboarea} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/sboarea.png}
\caption{sboarea (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_sboarea-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{xcom (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{xcom from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_xcom} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/xcom.png}
\caption{xcom (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_xcom-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{xcom\_fw (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{xcom\_fw from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_xcom_fw} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/xcom_fw.png}
\caption{xcom\_fw (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_xcom_fw-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{xoamc (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{xoamc from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_xoamc} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/xoamc.png}
\caption{xoamc (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_xoamc-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{xoamc\_si (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{xoamc\_si from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_xoamc_si} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/xoamc_si.png}
\caption{xoamc\_si (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_xoamc_si-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{xoamp (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{xoamp from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_xoamp} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/xoamp.png}
\caption{xoamp (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_xoamp-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{xoamp\_dsl (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{xoamp\_dsl from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_xoamp_dsl} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/xoamp_dsl.png}
\caption{xoamp\_dsl (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_xoamp_dsl-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{xoamp\_fw (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{xoamp\_fw from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_xoamp_fw} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/xoamp_fw.png}
\caption{xoamp\_fw (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_xoamp_fw-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{ycom (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{ycom from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_ycom} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/ycom.png}
\caption{ycom (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_ycom-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{ycom\_fw (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{ycom\_fw from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_ycom_fw} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/ycom_fw.png}
\caption{ycom\_fw (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_ycom_fw-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{yoamc (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{yoamc from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_yoamc} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/yoamc.png}
\caption{yoamc (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_yoamc-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{yoamc\_si (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{yoamc\_si from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_yoamc_si} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/yoamc_si.png}
\caption{yoamc\_si (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_yoamc_si-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{yoamp (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{yoamp from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_yoamp} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/yoamp.png}
\caption{yoamp (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_yoamp-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{yoamp\_dsl (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{yoamp\_dsl from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_yoamp_dsl} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/yoamp_dsl.png}
\caption{yoamp\_dsl (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_yoamp_dsl-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{yoamp\_fw (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{yoamp\_fw from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_yoamp_fw} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/yoamp_fw.png}
\caption{yoamp\_fw (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_yoamp_fw-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{zcom (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{zcom from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_zcom} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/zcom.png}
\caption{zcom (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_zcom-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{zcom\_fw (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{zcom\_fw from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_zcom_fw} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/zcom_fw.png}
\caption{zcom\_fw (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_zcom_fw-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{zoamc (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{zoamc from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_zoamc} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/zoamc.png}
\caption{zoamc (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_zoamc-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{zoamc\_si (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{zoamc\_si from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_zoamc_si} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/zoamc_si.png}
\caption{zoamc\_si (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_zoamc_si-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{zoamp (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{zoamp from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_zoamp} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/zoamp.png}
\caption{zoamp (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_zoamp-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{zoamp\_dsl (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{zoamp\_dsl from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_zoamp_dsl} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/zoamp_dsl.png}
\caption{zoamp\_dsl (1D)}
\label{tab:table-SBO_CORE_PRODUCTS_zoamp_dsl-Plot}
\end{figure}
\newpage
\pagebreak
\subsubsection{zoamp\_fw (1D)}
\begin{longtable}{|m{0.06\textwidth}|m{0.3\textwidth}|m{0.45\textwidth}|m{0.12\textwidth}|}
\caption{zoamp\_fw from SBO\_CORE\_PRODUCTS (1D)}\label{tab:table-SBO_CORE_PRODUCTS_zoamp_fw} \\ 
\hline \endhead \hline \endfoot
\rowcolor{lightgray} \textbf{Storage Type} & \textbf{Variable Name} & \textbf{Description} & \textbf{Unit} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.55]{/Users/brucel/ecco/yip/ECCO-Dataset-Production/document_generator/files_general/resource_files/version_specific/v4r4/output_and_granules/output/figures/figures_variables_1D/SBO_Core_Products/zoamp_fw.png}
\caption{zoamp\_fw (1D)}
