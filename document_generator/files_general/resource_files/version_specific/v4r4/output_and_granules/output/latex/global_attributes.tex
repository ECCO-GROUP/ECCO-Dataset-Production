...
\rowcolor{cyan!25} 
comment & string & Miscellaneous information about the data, not captured elsewhere. & CF, ACDD \\ \hline

\rowcolor{cyan!25} 
conventions & string & A comma-separated list of the conventions that the data follow. For files that follow this version of ACDD, include the string “ACDD-1.3” & CF, ACDD \\ \hline
...
\rowcolor{cyan!25} 
product\_time\_coverage\_end & string & Describes the time of the last data point in the overall model run. Use the ISO 8601:2004 date format, preferably the extended format as recommended in ACDD.  Example: For a model run spanning the years 1992-2017, this might be “2018-01-01T00:00:00” & ECCO \\ \hline

\rowcolor{cyan!25} 
product\_time\_coverage\_start & string & Describes the time of the first data point in the overall model run. Use the ISO 8601:2004 date format, preferably the extended format as recommended in ACDD.  Example: For a model run spanning the years 1992-2018, this might be “1992-01-01T12:00:00” & ECCO \\ \hline
