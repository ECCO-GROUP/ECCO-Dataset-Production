...
The colours defined in the following table are used throughout the GDS.
\begin{table}[h]
    \centering
...
Computer storage types referred to in the GDS are defined in the following table, which comports with netCDF standards.
