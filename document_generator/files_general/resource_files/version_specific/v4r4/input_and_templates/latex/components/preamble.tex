...
\fancyhead[R]{\small ECCO V4r4 Dataset Catalog and Variable Compendium\\}
...
%\fancyfoot[C]{\small ECCO V4r4 Dataset Catalog and Variable Compendium \\
%Last saved: \today{} \currenttime, \\ \Large{-- \thepage{} --}}
% Last saved: \today{} \currenttime, \\ \Large{-- \thepage{} --}}
...
\title{The ECCO V4r4 Dataset Catalog and Variable Compendium}
