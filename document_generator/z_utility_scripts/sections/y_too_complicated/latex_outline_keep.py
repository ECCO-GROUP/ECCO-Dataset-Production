...
def write_data_attributes_tables(config_file_static, config_file_user):
    ...
    for json_filepath in config_dict_static[config_json_list_name]:
        if search_string in json_filepath:
            ...
            for latex_filepath in config_dict_static[config_latex_list_name]:
